...
sudo /home/alumno/pmd-bin-7.0.0-rc2/bin/pmd check -d . -R rulesets/java/quickstart.xml -f text > ../ANALISIS_ESTATICO/analisis_easybuggy
...
sudo cp ./target/ROOT.war ../ENTREGABLES/
